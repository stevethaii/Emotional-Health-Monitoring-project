...
import com.example.dinhthai.sendingandreceivingdata.pulltorefresh.PullToRefresh;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        not_found.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Select.this, com.example.dinhthai.sendingandreceivingdata.Scan.class);
                startActivity(i);
            }
        });
