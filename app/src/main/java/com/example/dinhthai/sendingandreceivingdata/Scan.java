...
import com.example.dinhthai.sendingandreceivingdata.Select;

import java.util.ArrayList;
import java.util.List;

import com.example.dinhthai.sendingandreceivingdata.bluetooth.Bluetooth;
public class Scan extends Activity implements com.example.dinhthai.sendingandreceivingdata.bluetooth.interfaces.DiscoveryCallback, AdapterView.OnItemClickListener {
